...
export function StickyMobileCTA({ productTitle, price, onAddToCart, isLoading, isAvailable }: StickyMobileCTAProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-background/95 backdrop-blur-sm border-t border-border px-4 py-3 transition-transform duration-500 ease-out">
